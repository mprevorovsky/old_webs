...
// zahlavi tabulky
$header = array('Kategorie produktů', 'Novinka');
$keys = array('kategorie', 'novinka');
$n_cols = count($header);
$result = mysql_query('SELECT * FROM `'.TB_KATEGORIE.'` ORDER BY kategorie ASC') or die(mysql_error());	
